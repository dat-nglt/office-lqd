              ...
              return (
                ...
                >
                  ...
                  <Box className="flex items-start justify-between gap-2 mb-2">
                    <Box className="flex-1 min-w-0">
                      <Box className="flex items-center gap-2">
                        ...
                        <Text className="font-semibold text-gray-900 line-clamp-1">{notif.title}</Text>
                      </Box>
                    </Box>
                    <button
                  ...
                  <Box className="flex items-center gap-2 mb-2 ">
                    <Box
                      className={`text-xs font-semibold px-2 py-0.5 rounded border ${getPriorityColor(notif.priority)}`}
                    >
                      {notif.priority}
                    </Box>
                        ...
                        {notif.work.oldTime && notif.work.newTime && (
                          <Box className="flex items-center gap-1">
                            ...
                            <Text>
                              ...
                              <span className="ml-1 font-semibold text-green-700">→ {notif.work.newTime}</span>
                            </Text>
                          </Box>
                        )}
                      </Box>
                          ...
                          <Box className="text-xs">
                            {notif.work.customer && (
                              <Text className="text-gray-700">
                                ...
                                <span className="font-semibold">{notif.work.customer}</span>
                              </Text>
                            )}
                            {notif.work.phone && (
                              <Text className="text-gray-700">
                                <span className="text-gray-500">SDT:</span>{" "}
                                <span className="font-semibold">{notif.work.phone}</span>
                              </Text>
                            )}
                          </Box>
                          {notif.work.phone && (
