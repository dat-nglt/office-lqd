                    ...
                    {filteredAttendance.length > 0 ? (
                        filteredAttendance.map((record) => {
                            ...
                            const durationMinutes =
                                ...
                                (record.check_in_time && record.check_out_time
                                    ? Math.round(
                                          (new Date(record.check_out_time) - new Date(record.check_in_time)) / 60000,
                                      )
                                    : 0);
                                    ...
                                    <Box className="flex justify-between items-center mt-3 pt-3 border-t border-gray-100">
                                        <Box className="flex items-center space-x-2">
                                            ...
                                            <Text className="text-sm text-gray-600">
                                                Giờ làm:{" "}
                                                <span className="font-semibold">{workingHours.toFixed(2)}h</span>
                                            </Text>
                                        </Box>
                        ...
                        <Box className="text-center py-12">
                            ...
                            <Text className="text-gray-500 text-sm mt-1">
                                Chưa có dữ liệu chấm công cho tháng {new Date().getMonth() + 1}/
