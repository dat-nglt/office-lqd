...
function OvertimeRequest() {
    ...
    const OvertimeRequestModal = async () => {
            ...
            <Box className="bg-gradient-to-r from-green-600 via-green-700 to-green-800 shadow-lg pb-4 relative overflow-hidden">
                ...
                <Box className="px-4 pt-10 mt-5 pb-4 relative z-10">
                    ...
                    <Box className="bg-white/10 backdrop-blur-md rounded-lg p-2 border border-white/20">
                        <Text size="small" className="text-green-100 flex items-center">
                ...
                <Box className="space-y-4">
                    ...
                    <Box className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        <Text className="font-semibold text-gray-800 mb-3 text-sm flex items-center">
                            <Icon icon="zi-clock-1" className="mr-2 text-green-600" size={16} />
                    ...
                    <Box className="bg-white rounded-lg p-4 shadow-sm border border-green-200">
                        <Text className="font-semibold text-gray-800 mb-3 text-sm flex items-center">
                        ...
                        {selectedProjectId ? (
                            <Box className="bg-green-50 rounded-lg p-3 border border-green-200 mb-3">
                        ...
                        <button
                            ...
                            className="w-full px-3 py-2.5 border-2 border-green-600 text-green-600 rounded-lg font-semibold hover:bg-green-50 transition-colors flex items-center justify-center gap-2"
                        >
                        ...
                        {selectedProjectId && (
                            <Box className="mt-3 p-3 bg-green-50 rounded-lg border border-green-200">
                                <Text className="text-xs text-green-800 flex items-center">
                    ...
                    <Box className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        <Text className="font-semibold text-gray-800 mb-2 text-sm flex items-center">
                            <Icon icon="zi-location" className="mr-2 text-green-600" size={16} />
                            Địa chỉ
                        </Text>
                        <Input
                    ...
                    <Box className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        <Text className="font-semibold text-gray-800 mb-2 text-sm flex items-center">
                            <Icon icon="zi-call" className="mr-2 text-green-600" size={16} />
                    ...
                    <Box className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                        <Text className="font-semibold text-gray-800 mb-2 text-sm flex items-center">
                            <Icon icon="zi-edit" className="mr-2 text-green-600" size={16} />
                            Ghi chú (Tùy chọn)
                        </Text>
                        <Input
