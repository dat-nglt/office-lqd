...
function HomePage() {
    ...
    return (
        <Page className="bg-gray-50 min-h-screen pb-20">
            <Header title="Dashboard Kỹ Thuật Viên" />
                ...
                <Box className="bg-white rounded-xl shadow-sm p-4 mb-4 border border-gray-100">
                    ...
                    <Box className="grid grid-cols-2 gap-3 mb-3">
                        <Box className="bg-blue-50 rounded-lg p-3 border border-blue-200 text-center">
                            ...
                            <Text className="text-xs text-gray-600 mt-1">Công việc giao hôm nay</Text>
                        </Box>
                        <Box className="bg-yellow-50 rounded-lg p-3 border border-yellow-200 text-center">
                            ...
                            <Text className="text-xs text-gray-600 mt-1">Chờ thực hiện</Text>
                        </Box>
                    </Box>
                    ...
                    <Box className="grid grid-cols-2 gap-3">
                        <Box className="bg-green-50 rounded-lg p-3 border border-green-200 text-center">
                            ...
                            <Text className="text-xs text-gray-600 mt-1">Hoàn thành</Text>
                        </Box>
                        <Box className="bg-purple-50 rounded-lg p-3 border border-purple-200 text-center">
                            ...
                            <Text className="text-xs text-gray-600 mt-1">Tổng giờ dự kiến</Text>
                        </Box>
                    </Box>
                </Box>
                ...
                <Box className="bg-white rounded-xl shadow-sm p-4 mb-4 border border-gray-100">
                    ...
                    <Box className="flex justify-between mt-2">
                        <Text className="text-xs text-gray-500">
                            <span className="font-semibold">{statistics.completed}</span> hoàn thành
                        </Text>
                        <Text className="text-xs text-gray-500">
                            <span className="font-semibold">{statistics.pending}</span> chờ xử lý
                        </Text>
                    </Box>
                </Box>
