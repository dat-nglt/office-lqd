  ...
  return (
    <Page className="bg-gray-50 min-h-screen">
      ...
      <Box className="px-4 pt-4 pb-28">
        {/* Status Badge */}
        <Box
          className={`rounded-lg px-4 py-3 mb-4 border-2 text-center font-semibold ${getStatusColor(
            workReport.status
          )}`}
        >
        ...
        <Box className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 mb-4 space-y-3">
          ...
          <Box className="border-t border-gray-100 pt-3">
            ...
            <Box className="flex items-center justify-between">
              ...
              <button className="text-blue-600 hover:text-blue-800 text-xs font-semibold">Gọi</button>
            </Box>
          </Box>
        </Box>
