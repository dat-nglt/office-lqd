  ...
  return (
    <Box className="p-4 hover:bg-gray-50 transition-colors bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <Box className="flex items-start justify-between gap-2 mb-2">
        ...
        <Box className={`px-2.5 py-1 rounded-full text-xs font-semibold border ${getStatusColor(work.status)}`}>
      ...
      <Box className="mb-2">
        <Box className="flex flex-wrap gap-2 mb-2">
          ...
          <Box className={`text-xs px-2 py-1 rounded font-medium ${getPriorityColor(work.priority)}`}>
      ...
      <Box className="mb-2 flex items-center gap-2">
        ...
        <Text className="text-sm font-semibold text-gray-700">{work.scheduledTime}</Text>
      </Box>
      ...
      <Box className="flex gap-2 mt-3">
        ...
        {work.status === "completed" && (
          <Button size="small" className="flex-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs">
