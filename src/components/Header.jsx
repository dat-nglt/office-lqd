...
function Header({ title, showBack = false, onBack, userInfo, currentTime }) {
  ...
  return (
    <Box className="bg-gradient-to-r from-green-600 via-green-700 to-green-800 dark:from-gray-800 dark:via-gray-900 dark:to-gray-950 rounded-b-3xl shadow-xl pb-6 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <Box className="absolute top-1/2 left-1/4 w-32 h-32 bg-green-400/10 rounded-full -translate-y-1/2"></Box>
      ...
      <Box className="px-4 pt-12 pb-2 relative z-10">
        ...
        <Box className="flex items-center justify-between mb-6">
          <Box className="flex items-center space-x-4">
            ...
            <Box>
              ...
              <Text size="small" className="text-green-100">
                {userInfo.position?.name || "Nhân sự vừa tham gia"}
              </Text>
            </Box>
          </Box>
          ...
          >
            <Icon icon="zi-info-circle" className="text-white" size={25} />
        ...
        <Box className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/20 shadow-lg">
          <Box className="flex justify-between items-start">
            ...
            <Text size="small" className="text-green-100 font-semibold">
          ...
          {/* <Box className="flex items-center space-x-3 bg-white/5 rounded-xl p-2 border border-white/10">
            <Text size="small" className="text-green-100 flex-1">
